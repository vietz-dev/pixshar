...
INSERT INTO "new_download_job" ("createdAt", "debounceUntil", "eventId", "failureReason", "id", "photoCount", "processedPhotos", "status", "updatedAt", "zipKey", "zipSizeBytes") SELECT "createdAt", "debounceUntil", "eventId", "failureReason", "id", "photoCount", "processedPhotos", "status", "updatedAt", "zipKey", "zipSizeBytes" FROM "download_job";
