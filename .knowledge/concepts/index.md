...
* [Download-Varianten](download-quality-tiers.md) - Kompakt (Display, 1920 px) und Original werden beide immer gebaut und angeboten; zwei unabhängige DownloadJobs pro Event (`quality`), Kompakt reuse `displayKey`, lazy Build, Segmented-Toggle-UI. Kein Flag in dieser Iteration
